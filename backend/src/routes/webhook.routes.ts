...
function getEventDescription(event: string): string {
  const descriptions: Record<string, string> = {
    ...
    [WebhookEvents.SOLUTION_CREATED]:
      'Triggered when a new solution is submitted',
    [WebhookEvents.SOLUTION_VERIFIED]: 'Triggered when a solution is verified',
    [WebhookEvents.SOLUTION_UPVOTED]:
      'Triggered when a solution receives an upvote',
    [WebhookEvents.USER_REGISTERED]: 'Triggered when a new user registers',
    [WebhookEvents.CATEGORY_CREATED]:
      'Triggered when a new category is created',
    [WebhookEvents.APPLICATION_CREATED]:
